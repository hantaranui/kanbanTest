...
function _buildToolbar() {
  ...
  /* Logo LaSuite — coin gauche de la toolbar */
  const logoWrap = document.createElement('div');
  logoWrap.className = 'ls-toolbar-logo';
  logoWrap.innerHTML = `<svg width="28" height="28" viewBox="0 0 329 331" fill="none" xmlns="http://www.w3.org/2000/svg" style="--marked-color:#B9FFB7;--text-color:#271B79;--second-marked-color:#16B7C7">
